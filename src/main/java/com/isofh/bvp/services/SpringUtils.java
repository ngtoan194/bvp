...
public class SpringUtils {
    ...
    public String renderView(HttpServletRequest request, ModelAndView mav) {
        try {
            View view = viewResolver.resolveViewName(mav.getViewName(), Locale.US);
            DummyResponse dummyResponse = new DummyResponse();
            dummyResponse.setContentType("text/html; charset=utf-8");
            HttpServletResponse localResponse = new MyHttpServletResponseWrapper(dummyResponse);
