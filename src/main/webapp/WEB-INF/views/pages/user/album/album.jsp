        ...
        <div class="album-list">
            ...
            <div class="container">
                ...
                <div class="album-inner">
                            ...
                            <div class="col-md-4 col-sm-4 col-xs-12">
                                <div class="sort">
                                    ...
                                    <div class="input-text">
                                        <select style="display: block !important;" ng-init="sortTime = false" ng-model="sortTime" class="form-control selectpicker">
                    ...
                    <div class="row">
                        <div class="col-md-4 col-sm-6 col-xs-12" ng-repeat="item in listAlbum | orderBy: 'createdDate':sortTime">
                            <div class="album-item">
                                <div class="album-image">
                                    <a href="/thu-vien-anh/{{item.album.linkAlias}}">
                                        <img ng-src="{{item.album.imagePreview.absoluteUrl()}}" alt="">
                                    </a>
                                ...
                                <div class="album-content">
                                    ...
                                    <a href="/thu-vien-anh/{{item.album.linkAlias}}" class="view-album">
                                        <img src="/static/images/quickview.png" alt="">
                                    </a>
                                    <h4 class="title-album">
                                        <a href="/thu-vien-anh/{{item.album.linkAlias}}">{{item.album.name}}</a>
                                    </h4>
            ...
            httpRequest.get("/album/search"
                ...
                , function (data) {
                    if (data.success) {
                        ...
                        $scope.listAlbum = $scope.listAlbum.concat(data.data.data);
                        $scope.loading = false;
                    }
                }, function (data) {
                    $scope.loading = false;
