...
<div ng-controller="updatePageController" class="edit-clinic">
    <div class="container">
        <div class="alert alert-info fade in">
            CHỈNH SỬA KHOA PHÒNG
        </div>
        <div class="x_content">
            <form class="smart-form" id="form-page" ng-validate="validationPage">
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="well padding-10" style="margin: 10px; ">
                        ...
                        <div class="form-item">
                            <div class="input-inner">
                                ...
                                <div class="input input-file">
                                    <div class="button">
                                        <input type="file" id="select-file-image-cover2"
                                               name="file1"
                                ...
                                <label ng-click="removeThumbnail(dataPage)"
                                       ng-if="dataPage.bannerImage && dataPage.bannerImage.length>0"
                                       style="position: absolute; cursor: pointer; margin-top: 11px; margin-left: 5px;">
                                    <%--<img src="/static/images/delete-icons8.png" style="width: 20px;">--%>
                                </label>
                                <img style="width: 100%; object-fit: cover; margin-top: 10px;"
                        ...
                        <div>
                            <a style="width: 47%;" class="btn btn-success"
                               href="/khoa-phong/quan-ly-hoat-dong/{{dataPage.linkAlias}}?pageId={{dataPage.id}}">
                                Hoạt động
                            </a>
                            <a style="width: 48%; margin-left: 10px;" class="btn btn-success"
                               href="/khoa-phong/quan-ly-album/{{dataPage.linkAlias}}?pageId={{dataPage.id}}">
                                Thư viện ảnh
                            </a>
                        </div>
                    </div>
                                    ...
                                    <tr class="table-tr-th">
                                        ...
                                        <td class="input-inner">
                                            <label class="input input-file"
                                                ...
                                                <%--id="text-file-image-cover-name3"--%>
                                                <%--readonly--%>
                                                <%--ng-model="dataDirectors.avatar"/>--%>
                                            </label>
                                    ...
                                    <tr class="table-tr-th">
                                        ...
                                        <td class="text-center">
                                            <label class="input input-file"
                                                ...
                                                <%--<input class="form-control" type="text"--%>
                                                <%--id="text-file-image-cover-name4"--%>
                                                <%--placeholder="Chọn file" readonly--%>
                                                <%--ng-model="dataDeputyDirectors.avatar"/>--%>
                                            </label>
                    ...
                    <div class="well padding-10" style="margin: 10px; ">
                        <div>
                            ...
                            <table id="table-list-mgr5" style="border-radius: 4px"
                                ...
                                <thead>
                                <tr class="table-tr-th">
                                    <th class="text-center">Tên đầu mục</th>
                                    <th class="text-center">Nội dung đầu mục</th>
                                    <th class="text-center">Thêm/Sửa/Xóa</th>
                                </tr>
                                </thead>
                                <tbody>
                                ...
                                <tr class="table-tr-th">
                                    ...
                                    <td class="text-justify">
                                        <textarea type="text"
                                                  ...
                                                  ckeditor
                                                  placeholder="Nhập nội dung đầu mục"
                                                  rows="2">
                                        </textarea>
                                    </td>
                ...
                <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12" style="margin-bottom: 130px;">
                    <button class="btn btn-success" ng-click="update()"> Cập nhật</button>
                    <a class="btn btn-success" href="/khoa-phong/gioi-thieu/{{dataPage.linkAlias}}">Hủy</a>
                </div>
            </form>
        </div>
    </div>
...
<script>
    ngApp.controller('updatePageController', function ($scope, httpRequest, fileManager, $sce) {
...
//                }
        ...
        if ($scope.dataPage.adminIds) {
            $scope.dataPage.adminIds = $scope.dataPage.adminIds.toString();
        }
        $scope.fileMgr = {
            chooseFile: function () {
        ...
        $scope.removeThumbnail = function () {
            $scope.dataPage.bannerImage = null;
        }
        ...
        $scope.removeThumbnailDirectors = function () {
            $scope.dataDirectors.avatar = null;
        }
        ...
        $scope.removeThumbnailDeputyDirectors = function () {
            $scope.dataDeputyDirectors.avatar = null;
        }
                ...
                httpRequest.post("/page/update/" + $scope.dataPage.id
                    ...
                    , function (data) {
                        if (data.success) {
                            ...
                            location.href = '/khoa-phong/gioi-thieu/' + $scope.dataPage.linkAlias
                            $scope.cancelData();
                        } else {
