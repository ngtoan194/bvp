...
<!-- page content -->
<div class="right_col" role="main" ng-controller="mgrHospitalUtilityController">
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2 style="min-width: 50%; font-size: 18px;">Quản lý dịch vụ tại bệnh viện
                            <small></small>
                        </h2>
                                    ...
                                    <table class="table table-striped table-bordered dataTable no-footer">
                                        ...
                                        <tr class="table-tr-th" ng-repeat="item in data">
                                            ...
                                            <td class="time-item text-center">
                                                {{item.hospitalUtility.name}}
                                            </td>
                                            <td class="time-item text-center">
                                                <a style="width: 60px !important; text-overflow: clip; word-break: break-word;"
                                                   target="_blank" href="{{item.hospitalUtility.href}}">{{checkHrefUtility(item.hospitalUtility)}}</a>
                                            </td>
                                            <td class="time-item text-center">
                                                <img style="width: 100px; height: 51px; object-fit: cover !important; "
                                                     ng-src="{{item.hospitalUtility.image.absoluteUrl()}}">
                                            </td>
                                            <td class="time-item text-center">
                                                {{item.hospitalUtility.createdDate.toDateObject('-').format("HH:mm dd-MM-yyyy")}}
                                            </td>
                                            <td class="time-item text-center">
                                                <div class="btn-group">
                                                    ...
                                                    <ul role="menu" class="dropdown-menu">
                                                        <li>
                                                            <a ng-click="showdataUpdate(item.hospitalUtility)">
                                                                <i class="fa fa-edit"></i>Sửa
                                                            </a>
                                                        </li>
                                                        <li class="divider"></li>
                                                        <li>
                                                            <a ng-click="delete(item.hospitalUtility)">
                            ...
                            <div class="col-md-3">
                                <div class="well padding-10">
                                    <div style="border-bottom: 3px solid #dddddd; margin-bottom: 10px;">
                                        <h2 class="title-right-box ng-scope" ng-if="!dataUtilitity.id">Thêm mới dịch vụ</h2>
                                        <h2 class="title-right-box ng-scope" ng-if="dataUtilitity.id">Cập nhật dịch vụ</h2>
                                    </div>
                                    <form id="form-utility" novalidate="novalidate" class="smart-form"
                                          ng-validate="validationUtility">
                                        <div>
                                            <div class="form-item">
                                                ...
                                                <div class="input-inner">
                                                    ...
                                                    <div class="input-text">
                                                        <input type="text" class="form-control" name="href"
                                                               ...
                                                               ng-model="dataUtilitity.href">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="input-inner">
                                                <span class="form-label" style="margin-top: 10px;">Ảnh
                                                </span>
                                                ...
                                                <div style="width: 100%; height: auto; display: flex;align-items:center; justify-content:center;">
                                                    <img style="max-width: 100%; max-height:229px; margin-top: 10px;"
                                                         ng-if="dataUtilitity.image"
                                                         id="img-cover"
                                                         ng-src="{{dataUtilitity.image.absoluteUrl()}}">
                                                </div>
                                            </div>
                                        </div>
                                        <div style="text-align: right; margin-top: 25px;">
                                            <button type="button" class="btn btn-primary" ng-if="!dataUtilitity.id"
                                                    ng-click="createUtilitityWithImg()">
                                                Thêm mới
                                            </button>
                                            <button type="button" class="btn btn-primary" ng-if="dataUtilitity.id"
                                                    ng-click="updateUtilitityWithImg(dataUtilitity)">
                                                Cập nhật
                                            </button>
                                            <button type="button" class="btn btn-default" ng-click="cancelData()">Hủy</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
