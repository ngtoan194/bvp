...
<!-- page content -->
<div class="right_col" role="main" ng-controller="mgrSubMenuController">
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2 style="min-width: 50%; font-size: 18px;">Quản lý menu cấp 2
                            <small></small>
                        </h2>
                            ...
                            <div class="col-md-9">
                                <div class="well padding-10">
                                    <table class="table table-striped table-bordered dataTable no-footer">
                                        ...
                                        <tbody>
                                        <tr class="table-tr-th" ng-repeat="item in subMenu | orderBy : 'menu.index'">
                                            ...
                                            <td class="time-item text-center">
                                                <div class="link-sub-menu">
                                                    <p style="text-align: left" ng-repeat="item2 in item.menus | limitTo:3 | orderBy : 'menu.index'">-
                                                        {{item2.name}}</p>
                                                    <a target="_blank" ng-if="item.menus.length >2"
                                                       href="/admin/quan-ly-menu3?menuId={{menuId}}&subMenuId={{item.menu.id}}">
                                                        Xem thêm...
                                                    </a>
                                                </div>
                                            </td>
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    <ul role="menu" class="dropdown-menu">
                                                        <li>
                                                            <a target="_blank"
                                                               href="/admin/quan-ly-menu3?menuId={{menuId}}&subMenuId={{item.menu.id}}">
                                                                <i class="fa fa-bars"></i>Menu cấp 3</a>
                                                        </li>
                            ...
                            <div class="col-md-3">
                                <div class="well padding-10">
                                    <div style="border-bottom: 3px solid #dddddd; margin-bottom: 10px;">
                                        <h2 class="title-right-box ng-scope">{{dataSubMenu.id?"Cập nhật":"Thêm mới"}}</h2>
                                    </div>
                                    <form id="form-sub-menu" novalidate="novalidate" class="smart-form"
                                          ng-validate="validationSubMenu">
                                        <div>
                                            <div class="form-item">
                                        ...
                                        <div style="text-align: right;">
                                            <button type="button" class="btn btn-success" ng-if="!dataSubMenu.id"
                                                    ng-click="createSubMenu()">
                                                Thêm mới
                                            </button>
                                            <button type="button" class="btn btn-success" ng-if="dataSubMenu.id"
                                                    ng-click="updateSubMenu(dataSubMenu)">
                                                Cập nhật
                                            </button>
